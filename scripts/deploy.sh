...
copyFileEssential() {
  ...
  ln -s $PWD/vendor $PWD/$DEPLOY_DIR/vendor
  ln -s $PWD/resources $PWD/$DEPLOY_DIR/resources
  ln -s $PWD/config $PWD/$DEPLOY_DIR/config
  ln -s $PWD/app $PWD/$DEPLOY_DIR/app
  ln -s $PWD/routes $PWD/$DEPLOY_DIR/routes
